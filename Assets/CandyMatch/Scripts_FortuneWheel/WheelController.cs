...
namespace MkeyFW // mkey fortune wheel
{
    ...
    public class WheelController : MonoBehaviour
    {
        ...
        [SerializeField]
        public SceneButton closeButton;
        [SerializeField]
        public TextMesh textMessage_1;
        [SerializeField]
        public TextMesh textMessage_2;
        [SerializeField]
        ...
        public void StartSpin(Action completeCallBack)
        {
            ...
            RotateWheel(() =>
            {
                ...
                bool isBigWin = false;
                int res = GetWinSector(ref isBigWin);
        ...
        private void CheckResult()
        {
            ...
            if (debug) Debug.Log("IsBigWin: " + isBigWin);
        }

        /// <summary>
        /// Return spin result, win secor
        /// </summary>
        /// <param name="isBigWin"></param>
        /// <returns></returns>
        public int GetWinSector(ref bool isBigWin)
        {
            isBigWin = false;
            if (sectors != null && currSector >= 0 && currSector < sectors.Length)
            {
        ...
        {
            if (debug) Debug.Log("SetTouchActivity(bool spinButtonActive, bool active)" + spinButtonActive + " : " + active);
