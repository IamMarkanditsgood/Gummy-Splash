...
namespace Mkey
{
    public class CombinedRandRocketAndLineBomb : CombinedBomb
    {
        [SerializeField]
        private DynamicClickBombRandRocket randRocketPrefab;
        [SerializeField]
        private DynamicClickBombObject bombLinePrefab;
        [SerializeField]
        ...
        internal override void PlayExplodeAnimation(GridCell gCell, float delay, Action completeCallBack)
        {
            ...
            anim.Add((callBack) => 
            {
                ...
                rR.SetToFront(true);
                rR.hitTargetAction += (_gC) => { explodeOverBoard(bombLinePrefab, _gC, callBack); };
